...
from kv_compaction_clean.beta_fit import (
    _fit_nonnegative_ridge_scale_matrix,
    _fit_nonnegative_scale_matrix,
    split_query_bank_train_eval,
)
from kv_compaction_clean.data_types import BoundaryCollection, CompactHeadRuntime, QuerySample
from kv_compaction_clean.key_selection import match_coreset_to_query_samples, select_keys
...
def patched_compaction_attention(
    ...
    modeling_qwen2.eager_attention_forward = compacted_attention_forward
    try:
        yield
    finally:
