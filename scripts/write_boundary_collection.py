...
from kv_compaction_clean.boundary_collection import (
...
def main() -> None:
    ...
    bundle = collect_teacher_forced_boundary_collection(sample, config)
    output_path = Path("artifacts/qwen25_smoke/boundary_collection.json")
